...
namespace nam
{
	...
	public:
		...
		void GetLocalYPR(float& yaw, float& pitch, float& roll) const;

		void SetWorldYPR(float yaw, float pitch, float roll);
		void RotateWorldYPR(float yaw, float pitch, float roll);
		void GetWorldYPR(float& yaw, float& pitch, float& roll) const;
	...
	private:
		...
		void UpdateWorldForward(float yaw, float pitch, float roll);
